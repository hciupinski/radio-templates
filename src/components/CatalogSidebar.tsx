import { ChevronDown, ChevronRight, Flag, Layers3, Stethoscope } from "lucide-react";
    ...
    <aside className="catalog-sidebar" aria-label="Nawigacja katalogu">
      ...
      {viewMode === "conditions" ? (
        <div className="sidebar-scroll sidebar-list-scroll">
          <section className="tree-panel tree-list-panel">
        ...
        <>
          <div className="sidebar-static">
            <section className="tree-panel tree-panel-fixed">
              <div className="tree-panel-label">
